These 2 projects are based on the [Ultralytics YOLO](https://github.com/ultralytics/ultralytics) prelearned model. The transfer learning was applied to it using the
